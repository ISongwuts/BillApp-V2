...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.customerButton = QPushButton(self.frame)
        self.customerButton.setObjectName(u"customerButton")
        self.customerButton.setMinimumSize(QSize(0, 30))
        self.customerButton.setCursor(QCursor(Qt.PointingHandCursor))
        icon1 = QIcon()
        icon1.addFile(u"assets/icon/light/users-solid.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.customerButton.setIcon(icon1)
        self.customerButton.setIconSize(QSize(18, 18))
        self.customerButton.setCheckable(True)
        self.customerButton.setChecked(False)

        self.verticalLayout_5.addWidget(self.customerButton)
        ...
        self.productPage.setStyleSheet(u"")
        self.stackPages.addWidget(self.productPage)
        ...
        self.customerPage.setStyleSheet(u"")
        self.stackPages.addWidget(self.customerPage)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"PRINT", None))
